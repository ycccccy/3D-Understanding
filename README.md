...
|---------------|-------|-------|-----------|------|
| MILO (2025-12) | [Seeing through Imagination: Learning Scene Geometry via Implicit Spatial World Modeling](https://arxiv.org/pdf/2512.01821) | RGB-D  Camera Para | <img width="700" alt="image" src="./Figs/3D_Scene_Understanding/S2-MLLM.png"/> | ScanRefer / Nr3D / Sr3D / Multiscan / ArkiScenes |
